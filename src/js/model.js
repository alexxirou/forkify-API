...
const redisClient = async () => {
  /**
  + * Sets data in Redis with the given key and value.
  + *
  + * @param {string} key - The key to set the data with.
  + * @param {any} value - The value to set.
  + * @param {string} [flag="NX"] - The flag to set the data with. Default is "NX".
  + * @param {number} [expiration=120] - The expiration time in seconds. Default is 120.
  + * @return {Promise<void>} - A promise that resolves when the data is set successfully.
  + */
  ...
  + * @return {Promise<any>} The retrieved data, parsed as JSON.
  + */
  ...
  /**
  + * Checks if data exists for a given key in Redis.
  + *
  ...
  /**
  + * Retrieves all objects associated with the given query key from Redis.
  + *
  + * @param {string} queryKey - The key used to query objects.
  + * @return {Promise<Array<Object>>} An array of objects associated with the query key.
  + */
  ...
  /**
  + * Adds objects to a query hash in Redis.
  + *
  + * @param {string} queryKey - The key associated with the query hash.
  + * @param {Array} objects - The objects to be added to the query hash.
  + * @return {Promise} A promise that resolves when the objects are added successfully.
  + */
